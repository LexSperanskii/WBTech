...
class InteractorAddToMyCommunitiesTest {
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun `invoke should call addToMyCommunities from repository and interactorLoadClient`() =
        runTest {

            systemUnderTest =
                InteractorAddToMyCommunitiesImpl(networkRepository, interactorLoadClient)
